...
pub fn run() {
    ...
    let run_result = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_app_runtime_cmd::agent_app_runtime_start_task,
            commands::agent_app_runtime_cmd::agent_app_runtime_cancel_task,
            commands::agent_app_runtime_cmd::agent_app_runtime_get_task,
            commands::agent_app_runtime_cmd::agent_app_runtime_submit_host_response,
