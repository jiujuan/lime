...
pub(crate) fn materialize_agent_app_output_contract_artifact_after_stream(
    ...
    materialize_agent_app_output_contract_artifact_after_stream_with_host(
        host,
        run_observation,
        thread_id,
        turn_id,
...
pub(super) fn materialize_agent_app_output_contract_artifact_after_stream_with_host(
