...
function main() {
  ...
  runElectronFixtureSmoke(
    "Claw 首页首发短问候热路径 Electron fixture",
    [
      "scripts/agent-runtime/claw-chat-current-fixture-smoke.mjs",
      "--scenario",
      "home-hotpath-greeting",
      "--prefix",
