            ...
            ...(isExpertPanelSkillsRuntimeScenario
              ? {
                  ...
                  expertPanelEvidenceSummaryVisible:
                    summary.expertPanelEvidenceSummary?.visible === true &&
                    summary.expertPanelEvidenceSummary?.hasTitle === true,
                  expertPanelEvidenceSummarySkillCountsVisible:
                    summary.expertPanelEvidenceSummary?.hasSkillCounts === true,
                  expertPanelEvidenceSummaryLatestSkillVisible:
                    summary.expertPanelEvidenceSummary?.hasLatestSkill === true,
                  expertPanelEvidenceSummaryRuntimeEnableVisible:
                    summary.expertPanelEvidenceSummary?.hasRuntimeEnable === true,
