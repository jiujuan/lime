...
export function buildScenarioAssertions(context) {
  ...
  const scenarioAssertions = isRightSurfaceVisualMatrixScenario
    ? {
        rightSurfaceVisualMatrixRequestedThroughAppServer:
          ...
          Boolean(rightSurfaceVisualMatrix.requests?.objectCanvas?.requestId),
        rightSurfaceVisualMatrixFilesSurfaceVisible:
          rightSurfaceVisualCaptures.files?.stable?.activeSurface === "files" &&
        ...
        rightSurfaceVisualMatrixObjectCanvasSurfaceVisible:
          rightSurfaceVisualCaptures.objectCanvas?.stable?.activeSurface ===
            "objectCanvas" &&
          rightSurfaceVisualCaptures.objectCanvas?.stable?.rootVisible === true,
        ...
        rightSurfaceVisualMatrixSurfacesMutuallyExclusive: [
          ...
          (capture) =>
            ...
            capture.visibleRootKinds[0] === capture.activeSurface,
        ),
        rightSurfaceVisualMatrixHostsFillRightSide: [
          ...
          (capture) =>
            ...
            capture?.geometry?.rootFillsHost === true,
        ),
    ...
    : isPlanScenario
      ? {
          ...
          guiPlanHistoryHydrateCompleted:
            ...
            summary.guiPlanHistoryHydrateCompleted?.hasAllPlanSteps === true &&
          ...
          readModelPlanHistoryHydratePreserved:
            ...
            summary.readModelPlanHistoryHydrate?.includesAllPlanSteps === true,
            ...
            : isSkillsRuntimeScenario
              ? {
                  ...
                  evidenceSkillBodyReadObserved:
                    summary.evidencePackSkillsRuntime?.skillBodyReadObserved ===
                    true,
                  evidenceSkillGateObserved:
                    summary.evidencePackSkillsRuntime?.skillGateObserved ===
                    true,
                  evidencePackSkillSearchObserved:
                    summary.evidencePackSkillsRuntime?.hasSkillSearchSummary ===
                      true &&
                  ...
                  guiExplicitSkillsRuntimeInputSubmitted:
                    summary.explicitSkillsRuntimeInputSend?.afterFill
                      ?.promptVisibleInTextarea === true &&
                    summary.explicitSkillsRuntimeInputSend?.clicked?.clicked ===
                      true,
                    ...
                    isExpertPanelSkillsRuntimeScenario
                      ? {
                          expertPlazaCatalogInjected:
                            ...
                            summary.expertPlazaSkillsRuntimeCatalog
                              ?.promptStarter === EXPERT_SKILLS_RUNTIME_PROMPT,
                          expertPlazaCardClicked:
                            summary.expertPlazaSkillsRuntimeLaunch?.clicked ===
                              true &&
                ...
                : hasCancelPhase
                            ...
                            guiContinueCompleted:
                              ...
                              (summary.guiContinueCompleted
                                ...
                                summary.guiContinueCompleted?.hasDoneText ===
                                  true) &&
                              summary.guiContinueCompleted?.textareaVisible ===
                                true &&
                              summary.guiContinueCompleted?.textareaDisabled ===
                                false &&
                              summary.guiContinueCompleted
                                ?.stopButtonVisible === false,
                  ...
                  : {
                      ...
                      eventReadProbeObserved:
                        ...
                        summary.eventReadProbe?.events?.eventTurnIds?.length ===
                          1 &&
                      ...
                      readModelEventReadAligned:
                        summary.eventReadProbe?.readModel?.containsTurnId ===
                          true &&
                        summary.eventReadProbe?.readModel?.containsReadText ===
                          true,
                      readModelToolCallAligned:
                        summary.eventReadProbe?.readModel?.containsToolCall ===
                          true &&
