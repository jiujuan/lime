...
const KNOWLEDGE_MATCHERS = [
  ...
  exact("lime-rs/src/commands/knowledge_cmd.rs"),
  exact("lime-rs/src/dev_bridge/dispatcher.rs"),
  exact("lime-rs/src/dev_bridge/dispatcher/files.rs"),
  exact("lime-rs/src/dev_bridge/dispatcher/knowledge.rs"),
  exact("lime-rs/src/skills/default_skills.rs"),
  exact("lime-rs/crates/core/src/models/mod.rs"),
  exact("lime-rs/crates/core/src/models/skill_model.rs"),
  prefix("lime-rs/resources/default-skills/knowledge_builder/"),
  prefix("lime-rs/resources/default-skills/personal-ip-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/brand-persona-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/brand-product-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/organization-knowhow-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/growth-strategy-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/content-operations-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/private-domain-operations-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/live-commerce-operations-knowledge-builder/"),
  prefix("lime-rs/resources/default-skills/campaign-operations-knowledge-builder/"),
...
const NON_KNOWLEDGE_MATCHERS = [
  ...
  exact("lime-rs/src/commands/layered_design_cmd.rs"),
