...
const checks = [
  ...
  },
  {
    ...
    snippets: [
      ...
      "submitHostResponse 不再回退 generic action/respond",
  ...
  },
  {
    ...
    snippets: [
      ...
      "typed pending request 已响应时提交成功",
      "typed pending request 不存在时 fail closed，不回退 generic respondAction",
    ...
    absentSnippets: [
      ...
      "AgentSessionActionRespondParams",
      "actionRespondParamsFromRuntimeRequest",
      "mockPriorityCommands",
      "defaultMocks",
      "invokeMockOnly",
    ],
  ...
  {
    name: "Plugin Agent capability exposes submitHostResponse without retired respondAction alias",
    files: [
      "src/features/plugin/sdk/capabilityCatalog.ts",
      "src/features/plugin/sdk/capabilityContract.ts",
      "src/features/plugin/runtime/capabilityDispatcherSdkDispatch.ts",
      "src/features/plugin/runtime/capabilityDispatcher.unit.test.ts",
    ],
    snippets: [
      '"submitHostResponse"',
