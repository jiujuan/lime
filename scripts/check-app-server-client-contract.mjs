...
const checks = [
  ...
  },
  {
    ...
    snippets: [
      ...
      "create_aster_provider(&provider_config)",
  ...
  },
  {
    ...
    snippets: [
      ...
      "interruptAgentRuntimeTurn 应经 Electron IPC 调 App Server turn/cancel",
  ...
  },
  {
    ...
    snippets: [
      ...
      "resolveAppServerRequestTimeoutMs(message.method)",
