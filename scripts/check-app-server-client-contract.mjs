...
const checks = [
  ...
  {
    name: "Desktop evidence pack export helper stays provider-only for App Server evidence/export",
  ...
  {
    name: "Runtime tool inventory collector remains internal App Server capability source",
    file: "lime-rs/src/commands/aster_agent_cmd/command_api/runtime_api.rs",
    snippets: [
