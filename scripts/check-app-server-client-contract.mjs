...
const checks = [
  ...
  },
  {
    ...
    snippets: [
      ...
      "turn_context,",
      "web_search_preflight_fails_before_network_when_current_tool_is_not_required",
    ],
  ...
  {
    name: "App Server runtime backend delegates Aster streaming loop to lime-agent",
  ...
  },
  {
    ...
    snippets: [
      ...
      'compat".to_string()',
      'canonical".to_string()',
      "test_convert_message_tool_response_marks_legacy_tool_end_as_compat",
      "test_convert_failed_message_tool_response_marks_legacy_tool_end_as_compat",
    ],
  },
  {
  ...
  },
  {
    ...
    files: [
      ...
      "src/components/agent/chat/hooks/useAsterAgentChat.test/slashSkillExecution.case.tsx",
    ],
    snippets: [
  ...
  {
    name: "Plugin runtime startTask exposes and forwards Claw turnConfig parity",
    files: [
