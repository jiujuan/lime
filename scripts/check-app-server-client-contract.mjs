...
const checks = [
  ...
  {
    name: "Renderer API key provider reads use App Server modelProvider methods",
  ...
  {
    name: "Renderer API key provider tests lock App Server current read path and compat write boundary",
  ...
  {
    name: "Renderer knowledge pack list uses App Server knowledgePack/list",
  ...
  {
    name: "Renderer knowledge tests lock App Server current list path and no legacy fallback",
    ...
    snippets: [
      ...
      "App Server 知识包列表缺少 packs 时不应回退 legacy knowledge_list_packs",
      '"knowledgePack/list"',
      "workingDir is required to list App Server knowledge packs",
      "App Server knowledgePack/list did not return packs",
      "expect(safeInvoke).not.toHaveBeenCalledWith(",
  ...
  {
    name: "Renderer automation job list uses App Server automationJob/list",
  ...
  {
    name: "Renderer automation tests lock App Server current list path and compat write boundary",
    ...
    snippets: [
      ...
      "自动化 scheduler/status/write 仍保持 Desktop compat 命令",
      '"automationJob/list"',
      "App Server automationJob/list did not return jobs",
      "expect(safeInvoke).not.toHaveBeenCalledWith(",
      '"get_automation_jobs"',
  ...
  {
    name: "Electron Desktop Host projects app data facade commands into App Server JSON-RPC",
  ...
  {
    name: "Rust client exposes typed fileSystem read helpers",
    file: "lime-rs/crates/app-server-client/src/lib.rs",
    snippets: [
      ...
      "file_system_read_helpers_use_current_methods",
    ],
  },
  {
  ...
  {
    name: "TypeScript protocol exposes typed fileSystem read contract",
    file: "packages/app-server-client/src/protocol.ts",
    snippets: [
  ...
  {
    name: "TypeScript client wraps typed fileSystem read helpers",
    file: "packages/app-server-client/src/index.ts",
    snippets: [
  ...
  },
  {
    ...
    snippets: [
      "METHOD_FILE_SYSTEM_LIST_DIRECTORY",
      "METHOD_FILE_SYSTEM_READ_FILE_PREVIEW",
      "builds file system read requests with current methods",
      "connection wraps file system read responses",
  ...
  },
  {
    ...
    snippets: [
      ...
      "未授权时 smoke 必须在 `wait-health`、`prepare-runtime`、`aster_agent_init`、`get_api_key_providers`、`test_api_key_provider_chat` 之前 fail closed",
