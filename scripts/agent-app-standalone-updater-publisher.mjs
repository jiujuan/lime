...
} from "./lib/agent-app-standalone-updater-publisher-core.mjs";
...
function printHelp() {
  console.log(`Usage:
  node scripts/agent-app-standalone-updater-publisher.mjs --release <release.json> --output-dir <dir> [options]
