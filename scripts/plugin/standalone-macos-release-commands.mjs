...
import {
  ...
  writeJsonFile,
} from "../lib/plugin-standalone-macos-release-commands-core.mjs";
...
function printHelp() {
  console.log(`Usage:
  node scripts/plugin/standalone-macos-release-commands.mjs --artifacts <artifacts.json> --output-root <dir> [options]
