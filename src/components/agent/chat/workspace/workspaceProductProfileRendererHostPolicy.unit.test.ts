...
import { buildWorkspaceProductProfileRendererHostPolicy } from "./workspaceProductProfileRendererHostPolicy";

describe("workspaceProductProfileRendererHostPolicy", () => {
  ...
  it("缺少授权字段时默认停在宿主占位", () => {
    expect(buildWorkspaceProductProfileRendererHostPolicy(null)).toMatchObject({
      status: "placeholder",
      executionMode: "host_placeholder",
      rendererExecutionModel: "host_placeholder_only",
      entryLoadPolicy: "not_loaded",
