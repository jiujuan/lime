import type { WorkspaceProductObject } from "./workspaceProductProfileModel";
import {
  buildWorkspaceProductProfileRendererHostPolicy,
  type WorkspaceProductProfileRendererHostPolicy,
} from "./workspaceProductProfileRendererHostPolicy";

export interface WorkspaceProductProfileRendererHost {
  ...
  entry: string | null;
  actionKeys: string[];
  policy: WorkspaceProductProfileRendererHostPolicy;
}
...
export function buildWorkspaceProductProfileRendererHost(
  object: WorkspaceProductObject,
): WorkspaceProductProfileRendererHost | null {
  ...
  return {
    ...
    policy: buildWorkspaceProductProfileRendererHostPolicy(
