...
import { buildAgentUiTeamWorkbenchViewModel } from "./agentUiTeamWorkbenchViewModel";

describe("agentUiTeamWorkbenchViewModel", () => {
  it("应按 v0.6 surface 顺序构建可交互工作台 section", () => {
    ...
    const model = buildAgentUiTeamWorkbenchViewModel(events, {
      latestLimit: 2,
    });
