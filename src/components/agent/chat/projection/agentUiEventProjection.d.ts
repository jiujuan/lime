...
export type AgentUiPhase = "draft" | "submitted" | "accepted" | "routing" | "preparing" | "planning" | "reasoning" | "acting" | "waiting" | "producing" | "reconciling" | "completed" | "failed" | "cancelled" | "interrupted" | "archived" | "hydrating" | "unknown" | "reviewing";
export type AgentUiSurface = "composer" | "conversation" | "inline_process" | "runtime_status" | "tool_ui" | "hitl" | "task_capsule" | "artifact_workspace" | "timeline_evidence" | "session_tabs" | "diagnostics" | "custom" | "unknown" | "team_roster" | "work_board" | "delegation_graph" | "handoff_lane" | "worker_notifications" | "review_lane" | "teammate_transcript" | "background_teammate" | "remote_teammate" | "team_policy";
export type AgentUiPersistence = "ephemeral_live" | "transcript" | "snapshot" | "archive" | "artifact_store" | "evidence_pack" | "diagnostics_log" | "ui_local" | "unknown";
export type AgentUiControl = "send" | "queue" | "steer" | "interrupt" | "approve" | "reject" | "answer" | "edit" | "retry" | "rollback" | "remove" | "export" | "open_detail" | "none" | "unknown" | "delegate" | "assign" | "continue_agent" | "wait" | "stop" | "close" | "request_review";
export type AgentUiEventClass = "session.opened" | "session.hydrated" | "session.updated" | "session.closed" | "run.started" | "run.status" | "run.finished" | "run.failed" | "plan.delta" | "plan.final" | "text.delta" | "text.final" | "reasoning.delta" | "reasoning.summary" | "tool.started" | "tool.args" | "tool.args.delta" | "tool.progress" | "tool.output.delta" | "tool.result" | "tool.failed" | "action.required" | "action.resolved" | "queue.changed" | "task.changed" | "agent.changed" | "context.changed" | "context.compaction.started" | "context.compaction.completed" | "permission.changed" | "artifact.created" | "artifact.updated" | "artifact.preview.ready" | "artifact.version.created" | "artifact.diff.ready" | "artifact.export.started" | "artifact.export.completed" | "artifact.failed" | "artifact.deleted" | "artifact.changed" | "evidence.changed" | "state.snapshot" | "state.delta" | "messages.snapshot" | "diagnostic.changed" | "metric.changed" | "agent.spawned" | "agent.completed" | "agent.handoff" | "team.changed" | "worker.notification" | "review.requested" | "review.completed";
export type AgentUiRuntimeEntity = "agent_turn" | "subagent_turn" | "automation_job" | "external_task" | "work_item" | "unknown";
export type AgentUiTopology = "solo_run" | "coordinator_team" | "parallel_workers" | "specialist_handoff" | "review_team" | "human_agent_board" | "background_teammate" | "remote_teammate" | "unknown";
export type AgentUiRuntimeStatus = "idle" | "queued" | "submitted" | "accepted" | "preparing" | "running" | "waiting" | "needs_input" | "plan_ready" | "completed" | "failed" | "aborted" | "cancelled" | "closed" | "not_found" | "unknown";
...
export type AgentUiRequestedFixExecutionStatus = "pending" | "assigned" | "running" | "completed" | "failed" | "blocked" | "cancelled";
...
export type AgentUiAutomationJobProjectionEvent = "loaded" | "created" | "updated" | "started" | "completed" | "failed" | "deleted";
type AutomationJobProjectionRecord = Partial<AutomationJobRecord> & Pick<AutomationJobRecord, "id" | "name">;
...
export type AgentUiTeamControlProjectionAction = "assign" | "close" | "close_completed" | "delegate" | "reassign" | "request_review" | "resume" | "send_input" | "stop" | "wait";
...
export type AgentUiRemoteTeammateProjectionEvent = "created" | "updated" | "needs_input" | "auth_required" | "artifact_updated" | "completed" | "failed" | "cancelled";
...
export declare function buildAgentUiAutomationJobProjectionEvents(input: AgentUiAutomationJobProjectionInput, context?: AgentUiProjectionContext): AgentUiProjectionEvent[];
export declare function buildAgentUiTeamControlProjectionEvents(input: AgentUiTeamControlProjectionInput, context?: AgentUiProjectionContext): AgentUiProjectionEvent[];
export declare function buildAgentUiRemoteTeammateProjectionEvents(input: AgentUiRemoteTeammateProjectionInput, context?: AgentUiProjectionContext): AgentUiProjectionEvent[];
export declare function buildAgentUiMetricChangedEvent(input: AgentUiMetricProjectionInput, context?: AgentUiProjectionContext): AgentUiProjectionEvent;
export {};
