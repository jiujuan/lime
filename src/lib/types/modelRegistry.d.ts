...
/** 模型输入/输出模态 */
export type ModelModality = "text" | "image" | "audio" | "video" | "file" | "embedding" | "json";
/** 运行时特性 */
export type ModelRuntimeFeature = "streaming" | "tool_calling" | "json_schema" | "reasoning" | "prompt_cache" | "responses_api" | "chat_completions_api" | "images_api";
/** 模型部署来源 */
export type ModelDeploymentSource = "local" | "user_cloud" | "oem_cloud";
/** 模型管理面 */
export type ModelManagementPlane = "local_settings" | "oem_control_plane" | "hybrid";
/** 模型别名来源 */
...
/** 模型状态 */
export type ModelStatus = "active" | "preview" | "alpha" | "beta" | "deprecated" | "legacy";
/** 模型服务等级 */
export type ModelTier = "mini" | "pro" | "max";
/** 模型数据来源 */
export type ModelSource = "embedded" | "models.dev" | "local" | "custom" | "api";
/** 增强的模型元数据 */
