...
export const AGENT_RUNTIME_COMMANDS = {
  ...
  getObjective: "agent_runtime_get_objective",
  setObjective: "agent_runtime_set_objective",
  updateObjectiveStatus: "agent_runtime_update_objective_status",
  clearObjective: "agent_runtime_clear_objective",
  continueObjective: "agent_runtime_continue_objective",
  auditObjective: "agent_runtime_audit_objective",
  ...
  restoreFileCheckpoint: "agent_runtime_restore_file_checkpoint",
...
export const AGENT_RUNTIME_COMMAND_DESCRIPTORS = [
  ...
  {
    key: "getObjective",
    command: AGENT_RUNTIME_COMMANDS.getObjective,
    domain: "thread",
    requestType: "{ sessionId: string }",
    responseType: "ManagedObjective | null",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "setObjective",
    command: AGENT_RUNTIME_COMMANDS.setObjective,
    domain: "thread",
    requestType: "AgentRuntimeSetObjectiveRequest",
    responseType: "ManagedObjective",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "updateObjectiveStatus",
    command: AGENT_RUNTIME_COMMANDS.updateObjectiveStatus,
    domain: "thread",
    requestType: "AgentRuntimeUpdateObjectiveStatusRequest",
    responseType: "ManagedObjective | null",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  ...
  {
    key: "clearObjective",
    command: AGENT_RUNTIME_COMMANDS.clearObjective,
    domain: "thread",
    requestType: "AgentRuntimeObjectiveSessionRequest",
    responseType: "AgentRuntimeClearObjectiveResult",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "continueObjective",
    command: AGENT_RUNTIME_COMMANDS.continueObjective,
    domain: "thread",
    requestType: "AgentRuntimeObjectiveSessionRequest",
    responseType: "AgentRuntimeContinueObjectiveResult",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "auditObjective",
    command: AGENT_RUNTIME_COMMANDS.auditObjective,
    domain: "thread",
    requestType: "AgentRuntimeObjectiveSessionRequest",
    responseType: "ManagedObjective",
    lifecycle: "current",
  ...
  {
    key: "restoreFileCheckpoint",
    command: AGENT_RUNTIME_COMMANDS.restoreFileCheckpoint,
    domain: "thread",
    requestType: "AgentRuntimeRestoreFileCheckpointRequest",
    responseType: "AgentRuntimeFileCheckpointRestoreResult",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
