...
const DEV_BRIDGE_AGENT_APP_INSTALLED_WRITE_TIMEOUT_MS = 240000;
const DEV_BRIDGE_AGENT_APP_PACKAGE_COMMAND_TIMEOUT_MS = 60000;
const DEV_BRIDGE_AGENT_APP_PACKAGE_INSPECT_TIMEOUT_MS = 240000;
...
export function resolveBridgeRequestTimeoutMs(
  ...
  switch (resolveDevBridgeCommandTimeoutProfile(cmd, args)) {
    ...
    case "agent-app-installed-write":
      return DEV_BRIDGE_AGENT_APP_INSTALLED_WRITE_TIMEOUT_MS;
    ...
    case "agent-app-package-inspect":
      return DEV_BRIDGE_AGENT_APP_PACKAGE_INSPECT_TIMEOUT_MS;
