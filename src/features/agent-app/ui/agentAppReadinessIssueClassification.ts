export type AgentAppReadinessIssueCategory =
  | "legacy"
  | "package"
  | "cloud"
  | "runtime"
...
export interface AgentAppReadinessIssueCategorySummary {
  category: AgentAppReadinessIssueCategory;
  count: number;
  codes: string[];
}

const ISSUE_CATEGORY_BY_CODE: Record<string, AgentAppReadinessIssueCategory> = {
...
const CATEGORY_PRIORITY: AgentAppReadinessIssueCategory[] = [
  "legacy",
  "package",
  "cloud",
  "runtime",
...
export function classifyAgentAppReadinessIssueCode(
  code: string | null | undefined,
): AgentAppReadinessIssueCategory {
...
export function summarizeAgentAppReadinessIssueCategories(
  ...
  for (const code of codes ?? []) {
    ...
    const category = classifyAgentAppReadinessIssueCode(normalized);
    const bucket =
...
export function getPrimaryAgentAppReadinessIssueCategory(
  summaries: readonly AgentAppReadinessIssueCategorySummary[],
