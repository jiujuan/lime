...
export const LIME_CAPABILITY_DEFINITIONS = [
  ...
  },
  {
    ...
    summary: "已退役的 App iframe 本地 workflow DSL 能力；current 控制面走 App Server workflow API。",
    appResponsibility: "不要在 iframe SDK 内启动本地 workflow，改由 Agent task 或宿主 current API 表达业务步骤。",
    limeResponsibility: "通过 workflow/read、workflow/cancel、workflow/retry、workflow/respond 托管运行状态、恢复、权限和 Host response。",
    profile: {},
  },
  {
    name: "lime.policy",
