...
export interface LimeCapabilityContractMap {
  ...
  "lime.storage": {
    ...
    set: { args: { key: string; value: unknown }; value: PluginStorageEntry };
    list: { args: undefined; value: PluginStorageEntry[] };
  ...
  "lime.agent": {
    startTask: { args: PluginTaskRequest; value: PluginTaskRecord };
    streamTask: { args: { taskId: string }; value: PluginTaskStreamEvent[] };
    getTask: { args: { taskId: string }; value: PluginTaskRecord | null };
    cancelTask: { args: { taskId: string }; value: PluginTaskRecord };
    retryTask: { args: { taskId: string }; value: PluginTaskRecord };
    submitHostResponse: {
      args: PluginTaskHostResponseRequest;
      value: PluginTaskHostResponseResult;
    };
    listTasks: { args: undefined; value: PluginTaskRecord[] };
    readWorkflow: {
