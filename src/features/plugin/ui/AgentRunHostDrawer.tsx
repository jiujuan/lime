...
export interface AgentRunUiState extends PluginHostAgentRunUiRequest {
...
function AgentRunMetricCards({
  ...
  const cards = [
    {
      label: t("plugin.apps.runtime.agentRun.metric.model"),
      value:
        readString(model?.label) ??
        (modelFromParts || null) ??
        t("plugin.apps.runtime.agentRun.emptyValue"),
    },
    {
      label: t("plugin.apps.runtime.agentRun.metric.tokens"),
      value: formatTokenUsage(process) ?? t("plugin.apps.runtime.agentRun.emptyValue"),
    },
    {
      label: t("plugin.apps.runtime.agentRun.metric.cost"),
      value: formatCost(process) ?? t("plugin.apps.runtime.agentRun.emptyValue"),
    },
    {
      label: t("plugin.apps.runtime.agentRun.metric.skills"),
...
function buildProjectionPanelLabels(
  ...
  const runtimeEvent = t("plugin.apps.runtime.agentRun.timeline.event");
  return {
    parts: {
      status: runtimeEvent,
      queue: runtimeEvent,
      answer: t("plugin.apps.runtime.agentRun.output"),
      reasoning: t("plugin.apps.runtime.agentRun.thinking"),
      tool: runtimeEvent,
      actionRequired: t(
        "plugin.apps.runtime.agentRun.facts.confirmations.itemFallback",
      ),
      actionResolved: t("plugin.apps.runtime.agentRun.facts.confirmations"),
      artifact: t(
        "plugin.apps.runtime.agentRun.facts.artifacts.itemFallback",
      ),
      evidence: t("plugin.apps.runtime.agentRun.facts.evidence.itemFallback"),
      diagnostic: runtimeEvent,
    },
    summary: {
      status: runtimeEvent,
      pendingActions: t("plugin.apps.runtime.agentRun.facts.confirmations"),
      tools: t("plugin.apps.runtime.agentRun.metric.skills"),
      artifacts: t("plugin.apps.runtime.agentRun.facts.artifacts"),
      evidence: t("plugin.apps.runtime.agentRun.facts.evidence"),
      queue: t("plugin.apps.runtime.agentRun.timeline.running"),
    },
    actionControls: {
      approve: t("plugin.apps.runtime.agentRun.action.approve"),
      reject: t("plugin.apps.runtime.agentRun.action.reject"),
      answer: t("plugin.apps.runtime.agentRun.action.answer"),
      edit: t("plugin.apps.runtime.agentRun.action.edit"),
      retry: t("plugin.apps.runtime.agentRun.action.retry"),
      interrupt: t("plugin.apps.runtime.agentRun.action.interrupt"),
      stop: t("plugin.apps.runtime.agentRun.action.stop"),
    },
    empty: t("plugin.apps.runtime.agentRun.timeline.empty"),
  };
}
    ...
    >
      <div className="rounded-2xl border border-slate-200 bg-white px-3 py-2 text-xs leading-5 text-slate-500">
        <div className="flex justify-between gap-3">
          <span>{t("plugin.apps.runtime.agentRun.taskId")}</span>
          <strong className="truncate text-slate-700">
            {taskId ?? t("plugin.apps.runtime.agentRun.emptyValue")}
          </strong>
        </div>
        <div className="mt-1 flex justify-between gap-3">
          <span>{t("plugin.apps.runtime.agentRun.bridgeAction")}</span>
          <strong className="truncate text-slate-700">
            {run.bridgeAction ?? t("plugin.apps.runtime.agentRun.emptyValue")}
          </strong>
        </div>
      </div>
...
export function AgentRunHostDrawer({
  ...
  const title = run.title ?? t("plugin.apps.runtime.agentRun.titleFallback");
  ...
  if (!expanded) {
    return (
      <button
        ...
        onClick={onExpand}
        aria-label={t("plugin.apps.runtime.agentRun.expand")}
        title={`${t("plugin.apps.runtime.agentRun.expand")} · ${title}`}
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="sr-only">
            {t("plugin.apps.runtime.agentRun.badge", { app: displayName })} · {title} ·{" "}
            {terminal
              ? t("plugin.apps.runtime.agentRun.timeline.collapsed")
              : t("plugin.apps.runtime.agentRun.expand")}
          </span>
  ...
  return (
    <aside
      ...
      aria-label={t("plugin.apps.runtime.agentRun.aria")}
    >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="flex items-center gap-2 text-xs font-semibold text-emerald-700">
              <Bot size={14} />
              {t("plugin.apps.runtime.agentRun.badge", { app: displayName })}
            </p>
            <h2 className="mt-1 truncate text-lg font-semibold text-slate-950">
              {title}
            </h2>
            <p className="mt-1 text-xs leading-5 text-slate-500">
              {t("plugin.apps.runtime.agentRun.subtitle")}
            </p>
          </div>
          <div className="flex shrink-0 items-center gap-2">
            <button
              ...
              onClick={onCollapse}
              aria-label={t("plugin.apps.runtime.agentRun.collapse")}
            >
            ...
            <button
              ...
              data-testid="plugin-host-agent-run-close"
              aria-label={t("plugin.apps.runtime.agentRun.close")}
            >
              <X size={16} />
            </button>
          </div>
