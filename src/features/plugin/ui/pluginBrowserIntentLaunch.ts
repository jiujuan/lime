...
export interface PluginBrowserIntentLaunchInput {
  appId: string;
  title?: string | null;
...
export type PluginBrowserIntentLaunchResult =
  | {
      status: "requested";
...
export function buildPluginBrowserIntentRightSurfaceRequestParams(
  input: PluginBrowserIntentLaunchInput,
...
export async function requestPluginBrowserRightSurfaceIntent(
  input: PluginBrowserIntentLaunchInput,
  ...
  const params = buildPluginBrowserIntentRightSurfaceRequestParams(input);
  if (!params) {
