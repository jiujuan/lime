...
describe("pluginRightSurfaceLaunch", () => {
  ...
  it("缺少 Claw target 时应跳过 Right Surface 投递", async () => {
    await expect(
      requestPluginRightSurfaceLaunch(baseInput, {
        appServerClient: {
          request: vi.fn(),
        },
      }),
