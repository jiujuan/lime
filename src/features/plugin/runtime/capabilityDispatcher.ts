...
type ToolExecutionAgentTaskRequest = PluginTaskRequest & {
...
type ConnectorAuthorizationAgentTaskRequest = PluginTaskRequest & {
  requiredCapabilities?: string[];
  capabilityHints?: string[];
  metadata?: Record<string, unknown>;
  sessionId?: string;
...
function assertStorageWriteDeclared(projection: PluginProjection): void {
...
function buildPluginStandardProfile(params: {
  manifestVersion?: string;
  agentRuntime?: unknown;
  requirements?: unknown;
  boundary?: unknown;
...
function readTaskRuntimeProcess(task: PluginTaskRecord) {
...
function sortTasksByNewest(tasks: PluginTaskRecord[]): PluginTaskRecord[] {
