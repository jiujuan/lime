...
interface TrustedPluginBridgeMessage {
...
interface PluginTaskSubscription {
...
function readDocumentVisibilityState(): PluginVisibilityState {
...
class PluginHostBridgeActionError extends Error {
