...
import type { InstalledPluginState, InstalledAppPreview } from "../types";
import {
...
describe("Plugin v2 shell descriptor", () => {
  ...
  it("Shell launch descriptor service 应把 UI entry 与安装模式分发隔离在 shell 模块", () => {
    ...
    const inLimeState = { installMode: "in_lime" } as InstalledPluginState;
