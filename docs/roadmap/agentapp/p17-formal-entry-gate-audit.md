...
| Cloud / LimeCore 边界 | `docs/roadmap/agentapp/README.md`、本文与 P16-H 均约束 Cloud 只做 catalog / release / tenant metadata。 | 通过 | P17 仍不能让 Cloud 运行 Agent、渲染 UI 或接管本地 storage。 |
