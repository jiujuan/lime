...
| `docs/roadmap/agentapp/*` | 更新 P16 验证证据和进入正式入口的 gate 判定。 |
...
git diff --check -- docs/roadmap/agentapp src/features/agent-app scripts/agent-app-lab-smoke.mjs package.json
...
| `git diff --check -- docs/roadmap/agentapp src/features/agent-app scripts/agent-app-lab-smoke.mjs package.json src/i18n/resources src/components/agent/chat/workspace/useSceneAppExecutionSummaryRuntime.test.tsx` | 通过。 |
