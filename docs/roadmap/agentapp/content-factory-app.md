...
| 业务功能 | Lime Capability |
|---|---|
| 文件上传和解析 | `lime.files`、`lime.tools` |
| 三层知识库管理 | `lime.storage`、`lime.knowledge` |
| 结构化抽取 / 文案 / 脚本 | `lime.agent`、Agent Skills |
| 批量任务、进度、中断 | `lime.workflow`、`lime.agent` |
| 内容表、报告、PPT | `lime.artifacts` |
