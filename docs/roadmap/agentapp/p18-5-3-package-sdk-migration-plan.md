...
6. 回填 `docs/roadmap/agentapp/p18-5-content-factory-sdk-regression.md`、`docs/roadmap/agentapp/p18-completion-audit.md` 和本计划。
...
5. `docs/roadmap/agentapp/p18-5-content-factory-sdk-regression.md` 与 `docs/roadmap/agentapp/p18-completion-audit.md` 回填最新证据。
