...
| --- | --- | --- | --- | --- |
| Codex | `main` | `5c19155cbd93bfa099016e7487259f61669823ff` | 2026-07-11 | protocol, Thread/Turn/Item, runtime, tools, context, state, skills, MCP, multi-agent, fixtures |
| OpenCode | `dev` | `9976269ab1accfc9f9dc98a4a688c516934de422` | 2026-07-10 | package ownership, provider/model/capability, ContentPart/LLMEvent, lowering, schema/client boundaries |

两个参照仓库当前 checkout clean；Lime 工作树不是 clean，快照以路径/命令为准。
