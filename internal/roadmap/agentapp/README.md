...
| current   | `internal/roadmap/agentapp/remote-install-evidence-2026-07-03.md`              | `content-factory-app@2.2.1` 生产远程上传、目录、注册码、下载验包和 GUI 安装签名门禁阻断证据。                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| [remote-install-evidence-2026-07-03.md](./remote-install-evidence-2026-07-03.md)                         | `content-factory-app@2.2.1` 生产远程安装复核证据：上传、目录、注册码、下载验包已通，GUI 确认安装因签名缺失阻断。                 |
