...
8. 媒体 worker preflight：`lime-rs/src/commands/media_task_cmd.rs`
9. Browser Assist preflight：`lime-rs/src/commands/aster_agent_cmd/tool_runtime/browser_tools.rs`
10. Skill tool preflight / metadata seed：`lime-rs/crates/agent/src/tools/skill_tool_gate.rs`
11. ServiceSkill compat guard：`lime-rs/src/commands/aster_agent_cmd/tool_runtime/service_skill_tools.rs`
12. Provider/model resolution：`lime-rs/src/commands/aster_agent_cmd/request_model_resolution.rs`
13. Permission turn gating：`lime-rs/src/commands/aster_agent_cmd/runtime_turn.rs`
