...
rg -n "File Manager|@资料|沉淀为项目资料|knowledge_import_source|knowledge_resolve_context|KnowledgePack" internal/roadmap/knowledge/prd.md
rg -n "v0.5.0|context-resolution|knowledge_validate_context_run|Agent Knowledge runtime" internal/roadmap/knowledge/prd.md
```
