...
| Filesystem / Durable Storage          | 已落地        | `internal/aiprompts/overview.md`、`lime-rs/src/commands/agent_cmd/tool_runtime/workspace_tools.rs`                                                                                                                                                         | Workspace、artifact、项目目录、文件工具都已经进入主链                                                                                                                                                         |
...
| Context Rot 治理                      | 部分落地      | `lime-rs/src/commands/agent_cmd/command_api/runtime_api.rs`、`lime-rs/crates/agent-rust/crates/agent/src/context_mgmt/mod.rs`、`lime-rs/crates/agent/src/tool_io_offload.rs`、`lime-rs/crates/agent-rust/crates/agent/src/context/compressor.rs` | 已有 compact、tool output compression、tool offload，但产品侧可见性与默认治理还不够强                                                                                                                         |
| Long-Horizon Execution                | 部分落地      | `lime-rs/src/commands/agent_cmd/runtime_turn.rs`、`lime-rs/src/commands/agent_cmd/tool_runtime/subagent_tools.rs`、`lime-rs/src/commands/agent_cmd/command_api/runtime_api.rs`                                                         | 已有 auto continue、provider continuation、subagent、queue/resume，但还没形成统一 completion loop                                                                                                             |
| Verification / Replay / Review        | 部分落地      | `internal/aiprompts/harness-engine-governance.md`、`lime-rs/src/commands/agent_cmd/command_api/runtime_api.rs`、`src/lib/agentRuntime/harnessVerificationPresentation.ts`、`lime-rs/src/services/runtime_review_decision_service.rs`                     | evidence / replay / analysis / review 已成链；前端 verification 展示语义已收敛到共享 helper，review template 也开始直接携带同一份 structured verification summary，但验证结果尚未成为所有后续动作的默认硬约束 |
...
- `lime-rs/src/commands/agent_cmd/tool_runtime/workspace_tools.rs`
...
- `lime-rs/crates/agent-rust/crates/agent/src/context_mgmt/mod.rs`
  证明 Agent 已有 continuation message 与 compact 后续写逻辑，Lime 不是完全没有 continuation。
- `lime-rs/crates/agent-rust/crates/agent/src/context/compressor.rs`
