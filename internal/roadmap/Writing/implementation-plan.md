...
- [x] `pluginContract.ts` 从 `1000` 行以上拆回阈值内；plugin package component normalizer、Agent App 投影和通用工具已拆分，并补齐 `clis` / `hooks` 的一等 contract 类型。
