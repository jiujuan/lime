...
- native tool 注册入口：`src-tauri/crates/aster-rust/crates/aster/src/tools/mod.rs`
- native alias 事实源：`src-tauri/crates/aster-rust/crates/aster/src/tools/registry.rs`
