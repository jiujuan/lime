...
- 2026-06-23：
  ...
  - `npm run smoke:agent-runtime-current-fixture`
    ...
    - 第二次结果：通过；聚合入口完成 history/cache hydration、final_done 工具收尾、Claw 终态 UI、Electron fixture guard、Coding Workbench Electron fixture、cancel-then-continue、Skills Runtime 三入口、MCP structuredContent、Expert Skills Runtime / Plaza / Panel Electron fixture；输出 `liveProviderUsed=false`。
