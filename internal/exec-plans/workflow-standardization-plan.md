...
- [x] 确认 P4 core 范围只包含 `read/cancel/retry/respond` control API；更多 waiting presentation 归入 P5 UI Projection 后续项。
...
- [ ] 扩展 `workflow/respond` 更多等待点类型的 GUI presentation。
