...
2. **SessionConfigBuilder** (lime-rs/crates/agent/src/agent_state_support.rs)
   - 用于构建 agent Agent 的会话配置
   - 当前字段：id、max_turns、system_prompt、include_context_trace
   - 缺少上下文压缩相关配置

3. **AgentWrapper** (lime-rs/src/agent/agent_agent.rs)
