...
```rust
// lime-rs/src/agent/definition.rs
...
```rust
// lime-rs/src/agent/tools/mod.rs
...
```rust
// lime-rs/src/agent/streaming.rs
...
```rust
// lime-rs/src/agent/tools/registry.rs
...
```rust
// lime-rs/src/agent/tools/security.rs
