...
pub(super) struct PluginWorkerOrchestration {
...
#[derive(Debug, Clone, Default)]
pub(super) struct PluginWorkerOrchestrationOverrides {
    pub(super) workflow_key: Option<String>,
    pub(super) hook_policy: Option<Value>,
    pub(super) subagents: Vec<String>,
    pub(super) skill_refs: Vec<String>,
...
pub(super) fn resolve_plugin_worker_orchestration(
    installed_state: &Value,
    task_kind: &str,
    overrides: PluginWorkerOrchestrationOverrides,
...
fn apply_overrides(
    resolved: &mut PluginWorkerOrchestration,
    overrides: PluginWorkerOrchestrationOverrides,
) {
...
fn orchestration_from_workflow(workflow: &Value, manifest: &Value) -> PluginWorkerOrchestration {
    let steps = workflow
        .get("steps")
