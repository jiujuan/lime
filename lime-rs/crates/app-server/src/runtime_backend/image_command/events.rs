use super::super::{image_tools, request_context::RuntimeSessionScope};
use super::{presentation, ImageCommandIntent};
use crate::{RuntimeCoreError, RuntimeEvent, RuntimeEventSink};
use agent_protocol::{
...
pub(super) fn workflow_run_id(scope: &RuntimeSessionScope) -> String {
...
pub(super) fn emit_workflow_run_started(
    intent: &ImageCommandIntent,
...
pub(super) fn emit_workflow_step_started(
    intent: &ImageCommandIntent,
    step_id: &str,
    title: &str,
    task_id: Option<&str>,
...
pub(super) fn emit_workflow_step_completed(
    intent: &ImageCommandIntent,
    step_id: &str,
    title: &str,
    status: &str,
...
pub(super) fn emit_workflow_run_completed(
    intent: &ImageCommandIntent,
    status: &str,
    task_id: Option<&str>,
    sink: &mut dyn RuntimeEventSink,
...
pub(super) fn emit_intent_accepted(
    intent: &ImageCommandIntent,
    sink: &mut dyn RuntimeEventSink,
) -> Result<(), RuntimeCoreError> {
...
pub(super) fn emit_assistant_intro(
    intent: &ImageCommandIntent,
    assistant_intro: &str,
    sink: &mut dyn RuntimeEventSink,
) -> Result<(), RuntimeCoreError> {
...
pub(super) fn emit_planning_summary(
    intent: &ImageCommandIntent,
...
pub(super) fn emit_presentation_generated(
    intent: &ImageCommandIntent,
...
pub(super) fn emit_parameter_required(
    intent: &ImageCommandIntent,
    missing: &str,
    sink: &mut dyn RuntimeEventSink,
) -> Result<(), RuntimeCoreError> {
...
pub(super) fn emit_task_created_turn_completed(
    task_id: &str,
    artifact_path: &str,
...
pub(super) fn emit_create_failed(
    intent: &ImageCommandIntent,
    reason_code: &str,
    message: &str,
    sink: &mut dyn RuntimeEventSink,
...
pub(super) fn emit_create_failed_after_tool_started(
    intent: &ImageCommandIntent,
    tool_call_id: &str,
    params: &MediaTaskArtifactImageCreateParams,
    started_at_ms: i64,
...
pub(super) fn tool_call_id(scope: &RuntimeSessionScope) -> String {
