//! Legacy session todo snapshot reader.
//!
...
//! the legacy session-detail todo field is removed. It must not depend on Aster
...
mod tests {
    ...
    #[test]
    fn projects_legacy_task_list_snapshot_without_aster_types() {
