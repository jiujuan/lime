...
pub(crate) fn require_runtime_store() -> Result<Arc<dyn ThreadRuntimeStore>, String> {
    ensure_runtime_dirs()?;
...
async fn require_runtime_store_async() -> Result<Arc<dyn ThreadRuntimeStore>, String> {
