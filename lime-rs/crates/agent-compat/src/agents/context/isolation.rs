...
mod tests {
    ...
    fn test_sandbox_restrictions_tool_allowed() {
        ...
        assert!(restrictions.is_tool_allowed("bash"));
        assert!(restrictions.is_tool_allowed("read_file"));
        assert!(!restrictions.is_tool_allowed("apply_patch"));
        ...
        let restrictions = SandboxRestrictions::default()
            .with_allowed_tools(vec!["bash", "read_file", "apply_patch"])
            .with_denied_tools(vec!["apply_patch"]);
        assert!(restrictions.is_tool_allowed("bash"));
        assert!(restrictions.is_tool_allowed("read_file"));
        assert!(!restrictions.is_tool_allowed("apply_patch")); // Denied takes precedence
    ...
    fn test_context_isolation_is_tool_allowed() {
        ...
        assert!(!isolation.is_tool_allowed(&sandbox.sandbox_id, "apply_patch"));
