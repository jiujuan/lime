...
pub const TASK_ENTRIES: &[TaskCatalogEntry] = &[
    TaskCatalogEntry {
        ...
        docs_dir: "lime-rs/resources/default-skills/image_generate",
    ...
    TaskCatalogEntry {
        ...
        docs_dir: "lime-rs/resources/default-skills/cover_generate",
    ...
    TaskCatalogEntry {
        ...
        docs_dir: "lime-rs/resources/default-skills/transcription_generate",
        example:
            "lime task create transcription --source-path \"/tmp/interview.wav\" --output-format srt",
    },
    TaskCatalogEntry {
...
pub const SKILL_ENTRIES: &[SkillCatalogEntry] = &[
    ...
    SkillCatalogEntry {
        ...
        skill_path: "lime-rs/resources/default-skills/image_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
        name: "cover_generate",
        ...
        skill_path: "lime-rs/resources/default-skills/cover_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
        name: "video_generate",
    ...
    SkillCatalogEntry {
        ...
        recommended_command:
            "lime task create transcription --source-path \"/tmp/interview.wav\" --output-format srt",
        skill_path: "lime-rs/resources/default-skills/transcription_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
    ...
    SkillCatalogEntry {
        ...
        skill_path: "lime-rs/resources/default-skills/webpage_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
        ...
        skill_path: "lime-rs/resources/default-skills/presentation_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
        name: "form_generate",
        ...
        skill_path: "lime-rs/resources/default-skills/form_generate/SKILL.md",
        references: &[],
    },
    SkillCatalogEntry {
