...
const APP_SERVER_AGENT_APP_INSTALLED_SAVE_TIMEOUT_MS = 240_000;
const APP_SERVER_AGENT_APP_PACKAGE_INSPECT_TIMEOUT_MS = 240_000;
...
function resolveDefaultAppServerRequestTimeoutMs(method: string): number {
  ...
  if (method === "agentAppInstalled/save") {
    return APP_SERVER_AGENT_APP_INSTALLED_SAVE_TIMEOUT_MS;
  }
  if (method === "agentAppLocalPackage/inspect") {
    return APP_SERVER_AGENT_APP_PACKAGE_INSPECT_TIMEOUT_MS;
  }
